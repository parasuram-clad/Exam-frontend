...
export function CalendarWidget() {
    ...
    const getStatus = (day: Date) => {
        ...
        if (isAfter(checkDay, today)) return undefined; // Upcoming day has no special status

        // Past days: deterministic mock logic for demo
        const d = checkDay.getDate();
        const m = checkDay.getMonth();
        // Just a simple pattern that changes slightly by month for demo
