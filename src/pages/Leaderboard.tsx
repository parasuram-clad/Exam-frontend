...
const leaderboardData: LeaderboardEntry[] = [
  { rank: 1, name: "Priya Sharma", initials: "PS", marks: 2850, accuracy: "95%", testsCompleted: 45 },
  { rank: 2, name: "Arun Kumar", initials: "AK", marks: 2720, accuracy: "92%", testsCompleted: 42, isCurrentUser: true },
  { rank: 3, name: "Sneha Reddy", initials: "SR", marks: 2650, accuracy: "91%", testsCompleted: 40 },
  { rank: 4, name: "Vikram Singh", initials: "VS", marks: 2580, accuracy: "89%", testsCompleted: 38 },
  { rank: 5, name: "Meena Kumari", initials: "MK", marks: 2520, accuracy: "88%", testsCompleted: 36 },
  { rank: 6, name: "Ravi Prakash", initials: "RP", marks: 2450, accuracy: "87%", testsCompleted: 35 },
  { rank: 7, name: "Lakshmi Devi", initials: "LD", marks: 2380, accuracy: "86%", testsCompleted: 34 },
  { rank: 8, name: "Karthik M", initials: "KM", marks: 2320, accuracy: "85%", testsCompleted: 33 },
  { rank: 9, name: "Anitha S", initials: "AS", marks: 2280, accuracy: "84%", testsCompleted: 32 },
  { rank: 10, name: "Suresh Kumar", initials: "SK", marks: 2240, accuracy: "83%", testsCompleted: 31 },
];
...
const Leaderboard = () => {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-card rounded-xl p-4 border border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-medium text-foreground">#{currentUserRank?.rank || 2}</p>
        ...
        <div className="bg-card rounded-xl p-4 border border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-medium text-foreground">{currentUserRank?.accuracy || "92%"}</p>
        ...
        <div className="bg-card rounded-xl p-4 border border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-medium text-foreground">{currentUserRank?.marks || 2720}</p>
        ...
        <div className="bg-card rounded-xl p-4 border border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-medium text-foreground">1,234</p>
      ...
      <div className="bg-gradient-to-br from-accent/20  to-accent/10 rounded-2xl p-4 md:p-6 mb-6 border border-accent/20 shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="bg-white/80 backdrop-blur-sm px-3 py-1.5 rounded-lg border border-accent/30 flex items-center gap-1.5 shadow-sm">
              ...
              <span className="text-slate-800 font-medium text-[10px] md:text-xs">Week 04</span>
            </div>
          </div>
