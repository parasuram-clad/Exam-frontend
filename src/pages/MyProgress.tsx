                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-7 gap-2 text-center">
                    {["S", "M", "T", "W", "T", "F", "S"].map((day, i) => (
                      <div key={i} className="text-sm font-semibold text-gray-400">
                        {day}
                      </div>
                    ))}
                  </div>
                  ...
                  {calendarWeeks.map((week, weekIndex) => (
                    <div key={weekIndex} className="grid grid-cols-7 gap-2">
                      {week.map((day, dayIndex) => {
                        ...
                        const isCompleted = day !== null && completedDays.has(day as number);
                        const isToday = day === today.getDate() && isCurrentMonthView;
                        const isFuture =
                          day !== null &&
                          new Date(viewDate.getFullYear(), viewDate.getMonth(), day as number) > today;
                            ...
                            {!day ? null : (
                              <div
                                className={cn(
                                  ...
                                  isCompleted && !isToday && "bg-[#1a1a2e] text-white",
